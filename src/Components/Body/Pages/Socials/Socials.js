    ...
    return (
        <div className="socials page">
            ...
            {instagram &&
                <div className="con">
                    <div className="media">
                        <img src="https://kenenisa.github.io/niq-portifolio/img/uniq-insta.jpg" alt="uniq" />
                        <div className="brand-icon">
                            <img src={ 'https://kenenisa.github.io/niq-portifolio/img/instagram.png'} alt="instagram" />
                        </div>
                    </div>
                    <div className="text">
            ...
            }
            {
                telegram === null ? '' : (
                    telegram ?
                        <div className="con">
                            <div className="media">
                                <img src="https://kenenisa.github.io/niq-portifolio/img/uniq.jpg" alt="uniq" />
                                <div className="brand-icon">
                                    <img src={ 'https://kenenisa.github.io/niq-portifolio/img/telegram.png'} alt="telegram" />
                                </div>
                            </div>
                            <div className="text">
